...
const ProjectsCard = ({title, des, src}) => {
  return (
    <div className='w-full xl:px-12 p-5 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:bg-gray-900 transition-colors duration-1000'>
      ...
      <div className='w-full mt-5 flex flex-col gap-6'>
        ...
        <div className='text-justify'>{des}</div>
      </div>
    </div>
  )
}
